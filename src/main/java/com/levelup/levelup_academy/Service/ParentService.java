...
public class ParentService {
    ...
    public void registerParent(ParentDTO parentDTO) {
        ...
        User user = new User(null, parentDTO.getUsername(), parentDTO.getPassword(), parentDTO.getEmail(), parentDTO.getFirstName(), parentDTO.getLastName(), parentDTO.getRole(), false, null, null,null,null,null,null,null,null);
