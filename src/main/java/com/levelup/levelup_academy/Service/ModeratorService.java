...
public class ModeratorService {
    ...
    public void registerModerator(ModeratorDTO moderatorDTO){
        ...
        User user = new User(null, moderatorDTO.getUsername(), moderatorDTO.getPassword(), moderatorDTO.getEmail(), moderatorDTO.getFirstName(), moderatorDTO.getLastName(), moderatorDTO.getRole(), false,null,null,null,null,null,null,null,null);
